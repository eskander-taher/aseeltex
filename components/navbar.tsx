    ...
    >
      <div className="mx-auto max-w-7xl px-4">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          {/* Logo - Right side */}
          <Link href="/" className="flex items-center gap-2 text-white hover:scale-105 transition-all duration-300">
            <Mountain className="w-6 h-6 lg:w-7 lg:h-7" />
            <span className="text-lg lg:text-xl font-bold tracking-wide">اسيلتكس</span>
          </Link>
